...
test("resolveLaunch uses the current upstream default branch when no ref is set", () => {
  ...
  assert.equal(launch.args[1], "open-compute[mcp,local,uia] @ git+https://github.com/ellmos-ai/open-compute.git@master");
});
